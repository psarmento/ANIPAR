...
stri = 'https://data.sdss.org/sas/dr14/apogee/spectro/redux/r8/stars/' #DR14, must be changed if wanting to download spectra from other DR
ns = 100
...
for j,name in enumerate(x2):
    ...
    stri += '\n' + 'https://data.sdss.org/sas/dr14/apogee/spectro/redux/r8/stars/'
